    ...
    >
      <div className="flex h-full flex-col p-4">
        <div className="h-16 flex items-center px-2 mb-6">
          ...
          <div>
            <span className="text-xl font-bold text-[var(--ds-text-primary)] tracking-tight block">AgentsFlow</span>
          </div>
          <button
            type="button"
          ...
          >
            ...
            >
              <span className="text-lg font-bold text-primary-600 dark:text-primary-400">
                {(companyName || 'AgentsFlow').charAt(0).toUpperCase()}
              </span>
            </div>
            <div className="flex-1 min-w-0 text-left">
              <p className="text-sm font-medium text-[var(--ds-text-primary)] truncate">{companyName || 'AgentsFlow'}</p>
