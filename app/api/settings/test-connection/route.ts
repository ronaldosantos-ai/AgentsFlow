  ...
  if (msg.includes('tried accessing nonexisting field') && msg.includes('whatsapp_business_account')) {
    return {
      ...
      nextSteps: [
        ...
        'No AgentsFlow, use o Diagnóstico Meta (settings/meta-diagnostics) para verificar acesso ao Phone e ao WABA.',
      ],
  ...
  if (msg.includes('api access deactivated') || msg.includes('to unarchive') || msg.includes('unarchive')) {
    return {
      ...
      nextSteps: [
        ...
        'Depois, volte no AgentsFlow e clique em “Testar Conexão”.',
      ],
      docs: 'https://developers.facebook.com/docs/graph-api',
    }
  }
