...
**AgentsFlow** é uma plataforma completa de automação de WhatsApp que ajuda você a se comunicar com clientes de forma mais inteligente e produtiva.

### Por que escolher AgentsFlow?
...
Este guia vai te levar do zero até ter o AgentsFlow funcionando.
...
1. Acesse o repositório do AgentsFlow
2. Clique no botão **Fork** (canto superior direito)
3. Escolha sua conta pessoal ou organização
4. Aguarde o fork ser criado

> **Pronto quando**: Você ver o repositório `agentsflow` na sua conta do GitHub
...
4. Selecione **agentsflow** (seu fork)
5. Clique em **Deploy**

> **Aguarde**: O deploy leva cerca de 2-3 minutos

6. Quando terminar, copie a URL do seu projeto (ex: `https://agentsflow-abc123.vercel.app`)
...
2. **O wizard tem 5 etapas:**
   ...
   **Etapa 2 - Vercel:**
   ...
   - Dê um nome (ex: "AgentsFlow Installer")
   ...
   **Etapa 5 - Redis:**
   ...
   - Nome: **agentsflow** • Região: **São Paulo** (ou mais próxima)
...
O AgentsFlow tem estas áreas principais:
...
O AgentsFlow usa dois serviços do Upstash:
...
2. Clique no seu projeto AgentsFlow
...
git clone https://github.com/SEU-USUARIO/agentsflow.git
cd agentsflow
